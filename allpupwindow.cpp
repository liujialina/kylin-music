...
void SongInfoWidget::songInfoDlgColor()
{
    if(WidgetStyle::themeColor == 1 )    //深色模式
    {
        ...
        titleLab->setStyleSheet("width:60px;height:14px;\
                                 font-weight:400;\
                                 border:none;\
                                 color: #F9F9F9;\
                                 line-height:14px;");
        artistLab->setStyleSheet("width:60px;height:14px;\
                                  font-weight:400;\
                                  border:none;\
                                  color: #F9F9F9;\
                                  line-height:14px;");
        albumLab->setStyleSheet("width:60px;height:14px;\
                                 font-weight:400;\
                                 border:none;\
                                 color: #F9F9F9;\
                                 line-height:14px;");
        typeLab->setStyleSheet("width:60px;height:14px;\
                                font-weight:400;\
                                border:none;\
                                color: #F9F9F9;\
                                line-height:14px;");
        sizeLab->setStyleSheet("width:60px;height:14px;\
                                font-weight:400;\
                                border:none;\
                                color: #F9F9F9;\
                                line-height:14px;");
        timeLab->setStyleSheet("width:60px;height:14px;\
                                font-weight:400;\
                                border:none;\
                                color: #F9F9F9;\
                                line-height:14px;");
        pathLab->setStyleSheet("width:60px;height:14px;\
                                font-weight:400;\
                                border:none;\
                                color: #F9F9F9;\
                                line-height:14px;");
...
//                                      color:#F9F9F9;");
        ...
        songInfoTitleLab->setStyleSheet("width:80px;height:14px;\
                                         font-weight: 600;\
                                         border:none;\
                                         color:#F9F9F9;\
                                         line-height:14px;");
